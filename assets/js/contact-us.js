...
/******/ 	deferredModules.push(["./src/assets/js/pages/contact-us.js","common"]);
...
/***/ "./src/assets/js/pages/contact-us.js":
/*!*******************************************!*\
  !*** ./src/assets/js/pages/contact-us.js ***!
  \*******************************************/
/*! no exports provided */
...
/* harmony import */ var _assets_js_utils_checkApp_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/assets/js/utils/checkApp.js */ "./src/assets/js/utils/checkApp.js");
...
/* harmony import */ var _components_Dialog_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/components/Dialog.vue */ "./src/components/Dialog.vue");
/* harmony import */ var _assets_style_pages_contact_us_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/assets/style/pages/contact-us.less */ "./src/assets/style/pages/contact-us.less");
/* harmony import */ var _assets_style_pages_contact_us_less__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_assets_style_pages_contact_us_less__WEBPACK_IMPORTED_MODULE_5__);
...
new _assets_js_main_js__WEBPACK_IMPORTED_MODULE_0__[/* Page */ "a"]({
  ...
  components: {
    ...
    BsDialog: _components_Dialog_vue__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"]
  },
  data: function data() {
    return {
      isShowGraphic: true,
      isShowDialog: false,
      isApp: Object(_assets_js_utils_checkApp_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])()
    };
  },
  mounted: function mounted() {},
  methods: {
    ...
    openIntercom: function openIntercom() {
      if (this.isApp) {
        window.location = 'https://buyandship/inapp/intercom';
      } else {
...
/***/ "./src/assets/style/pages/contact-us.less":
/*!************************************************!*\
  !*** ./src/assets/style/pages/contact-us.less ***!
  \************************************************/
/*! no static exports found */
