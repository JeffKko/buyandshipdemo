...
/******/ 	deferredModules.push(["./src/assets/js/pages/warehouses.js","common"]);
...
/***/ "./src/assets/js/pages/warehouses.js":
/*!*******************************************!*\
  !*** ./src/assets/js/pages/warehouses.js ***!
  \*******************************************/
/*! no exports provided */
...
/* harmony import */ var _assets_js_utils_hybridPage_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/assets/js/utils/hybridPage.js */ "./src/assets/js/utils/hybridPage.js");
/* harmony import */ var _components_Slideshow_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/components/Slideshow.vue */ "./src/components/Slideshow.vue");
/* harmony import */ var _components_Dialog_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/components/Dialog.vue */ "./src/components/Dialog.vue");
/* harmony import */ var intersection_observer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! intersection-observer */ "./node_modules/intersection-observer/intersection-observer.js");
...
/* harmony import */ var _assets_style_pages_warehouses_less__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/assets/style/pages/warehouses.less */ "./src/assets/style/pages/warehouses.less");
/* harmony import */ var _assets_style_pages_warehouses_less__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_assets_style_pages_warehouses_less__WEBPACK_IMPORTED_MODULE_9__);
...
Object(_assets_js_utils_hybridPage_js__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])();
new _assets_js_main_js__WEBPACK_IMPORTED_MODULE_4__[/* Page */ "a"]({
  el: '#bsMain',
  components: {
    BsSlideshow: _components_Slideshow_vue__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"],
    BsDialog: _components_Dialog_vue__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"]
  },
  data: function data() {
    return {
      isShowDialog: false,
  ...
  mounted: function mounted() {
    this.initObserver();
    window.SmoothScroll = smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default.a;
  },
  methods: {
    scrollToTop: function scrollToTop() {
      // let scroll = new SmoothScroll()
      // scroll.animateScroll(0)
      this.$refs.mainTitle.scrollIntoView({
        behavior: 'smooth'
      });
    },
    scrollToSubtitle: function scrollToSubtitle() {
      document.querySelector("div[data-title=\"".concat(this.currentAnchorTitle, "\"]")).scrollIntoView({
        behavior: 'smooth'
      });
    },
    showGallery: function showGallery(image) {
      if (document.body.offsetWidth > 768) return false;
      this.isShowDialog = true;
      var scroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default.a(); // let anchor = this.$refs[image]

      var anchor = document.querySelector(".bs-card[data-image=\"".concat(image, "\"]"));
      ...
      var observerTitle = new IntersectionObserver(function (entries, observer) {
        entries.forEach(function (entry) {
          ...
          if (entry.isIntersecting) {
            _this.currentAnchorTitle = entry.target.innerText;
          }
        });
      });
      var observerDesc = new IntersectionObserver(function (entries, observer) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            _this.currentAnchorDesc = entry.target.dataset.desc;
          }
        });
      });
      var anchorTitle = document.querySelectorAll('[data-title]');
      var anchorDesc = document.querySelectorAll('[data-desc]');

      _babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_2___default()(anchorTitle).forEach(function (v) {
        return observerTitle.observe(v);
      });

      _babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_2___default()(anchorDesc).forEach(function (v) {
        return observerDesc.observe(v);
      });
    }
  }
});
...
/***/ "./src/assets/style/pages/warehouses.less":
/*!************************************************!*\
  !*** ./src/assets/style/pages/warehouses.less ***!
  \************************************************/
/*! no static exports found */
